...
if __name__ == "__main__":
    filename = "C:\\Users\\user\\Downloads\\7.txt"
    ...
    if polygon:
        ...
        # แสดงผลตัวเลข
        print("-" * 30) # แยกผลลัพธ์
        print(f"Minimum Cost: {min_cost:.4f}") #สามเหลี่ยมที่แสดงเกิดจากการเลือกเส้นที่ให้ค่าน้อยที่สุด เพื่อให้ได้เส้นรอบรูปที่สั้นที่สุด
        ...
        print("-" * 30)
        print(f"Maximum Cost: {max_cost:.4f}") #สามเหลี่ยมที่แสดงเกิดจากการเลือกเส้นที่ให้ค่ามากที่สุด เพื่อให้ได้เส้นรอบรูปที่ยาวที่สุด
