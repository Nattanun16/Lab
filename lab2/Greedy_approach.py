def greedy(
    ...
    for g in grabs:  # วนลูปผ่าน Grab แต่ละคัน
        ...
        candidates = [
            p for p in passengers if p not in used and abs(g - p) <= k
        ]  # ใช้ list comprehension เพื่อสร้างลิสต์ candidates ที่เก็บ Passenger ที่ยังไม่ถูกใช้ และอยู่ในระยะที่ Grab สามารถรับได้
